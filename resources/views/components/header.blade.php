...
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        <ul class="navbar-nav mr-3">
            ...
            <li><a class="nav-link nav-link-lg d-sm-none" data-toggle="search" href="#"><i
        ...
        <div class="search-element">
            ...
            <div class="search-result">
                ...
                <div class="search-item">
                    <a href="#">
                        <img alt="product" class="mr-3 rounded" src="{{ asset('img/products/product-3-50.png') }}"
                            width="30">
                ...
                <div class="search-item">
                    <a href="#">
                        <img alt="product" class="mr-3 rounded" src="{{ asset('img/products/product-2-50.png') }}"
                            width="30">
                        Drone X2 New Gen-7
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img alt="product" class="mr-3 rounded" src="{{ asset('img/products/product-1-50.png') }}"
                            width="30">
                        Headphone Blitz
                    </a>
                </div>
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle"><a class="nav-link nav-link-lg message-toggle beep"
                data-toggle="dropdown" href="#"><i class="far fa-envelope"></i></a>
        ...
        <li class="dropdown dropdown-list-toggle"><a class="nav-link notification-toggle nav-link-lg beep"
                data-toggle="dropdown" href="#"><i class="far fa-bell"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
        ...
        <li class="dropdown">
            <a class="nav-link dropdown-toggle nav-link-lg nav-link-user" data-toggle="dropdown" href="#">
                <img alt="image" class="rounded-circle mr-1" src="{{ asset('img/avatar/avatar-1.png') }}">
