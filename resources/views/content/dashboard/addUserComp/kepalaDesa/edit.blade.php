                ...
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('tambah-user.update', $id) }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <input name="role" type="hidden" value="kepalaDesa">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control datepicker" id="date_of_birth" name="date_of_birth"
                                            type="date" value="{{ $data->kades->date_of_birth }}">
                                        @error('date_of_birth')
                                            <span class="text-danger text-small">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control" id="place_of_birth" name="place_of_birth" type="text"
                                            value="{{ $data->kades->place_of_birth }}">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control selectric" id="gender" name="gender">
                                            ...
                                            <option {{ $data->kades->gender == 'Laki-laki' ? 'selected' : '' }}
                                                value="Laki-laki">
                                                Laki-laki
                                            </option>
                                            <option {{ $data->kades->gender == 'Perempuan' ? 'selected' : '' }}
                                                value="Perempuan">
                                                Perempuan
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control selectric" id="last_educations" name="last_educations">
                                            <option disabled selected value="">-- Pilih Pendidikan --
                                            </option>
                                            <option {{ $data->kades->last_educations == 'SD ' ? 'selected' : '' }}
                                                value="SD/MI/Sederajat">
                                                SD/MI/Sederajat
                                            </option>

                                            <option
                                                {{ $data->kades->last_educations == 'SMP/MTS/Sederajat' ? 'selected' : '' }}
                                                value="SMP/MTS/Sederajat">SMP/MTS/Sederajat
                                            </option>

                                            <option
                                                {{ $data->kades->last_educations == 'SMA/MA/Sederajat' ? 'selected' : '' }}
                                                value="SMA/MA/Sederajat">SMA/MA/Sederajat
                                            </option>

                                            <option {{ $data->kades->last_educations == 'D1' ? 'selected' : '' }}
                                                value="D1">D1
                                            </option>
                                            <option {{ $data->kades->last_educations == 'D2' ? 'selected' : '' }}
                                                value="D2">D2
                                            </option>
                                            </option>
                                            <option {{ $data->kades->last_educations == 'D3' ? 'selected' : '' }}
                                                value="D3">D3
                                            </option>
                                            <option {{ $data->kades->last_educations == 'S1/D4' ? 'selected' : '' }}
                                                value="S1/D4">S1/D4
                                            </option>
                                            <option {{ $data->kades->last_educations == 'S2' ? 'selected' : '' }}
                                                value="S2">S2
                                            </option>
                                            <option {{ $data->kades->last_educations == 'S3' ? 'selected' : '' }}
                                                value="S3">S3
                                            </option>
                                        </select>
                            ...
                            <div class="card-footer text-right">
                                <button class="btn btn-primary" type="submit">Update Kepala Desa</button>
                            </div>
                        </form>
                    </div>
                </div>
